class AddDeviseToPlayers < ActiveRecord::Migration
  ...
  def self.down
    ...
    ## Trackable
    remove_column :players, :sign_in_count
    remove_column :players, :current_sign_in_at
    remove_column :players, :last_sign_in_at
    remove_column :players, :current_sign_in_ip
    remove_column :players, :last_sign_in_ip
  end
end
